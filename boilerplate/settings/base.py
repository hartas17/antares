...
SECRET_KEY = 'q#4ot4302m^yx2$v$dhant-bjo7nl#b)jhhppe2hb#m@77x6g$'
...
MEDIA_URL = '/media/'
MEDIA_ROOT = os.path.join(BASE_DIR, '../boilerplate/media/')

# Send Email configuration
EMAIL_HOST = 'smtp.gmail.com'
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'temporal@temp.com.mx'
EMAIL_HOST_PASSWORD = 'rohzuX-pacvir-wekci1'
EMAIL_PORT = 587
